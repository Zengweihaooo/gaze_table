...
# ================= Data =================
# BenchmarkV: 0.40 (±4.79)
# BenchmarkR: Low 8.30 (±6.82), High 8.63 (±5.92)
# Controller: Low 1.10 (±4.43), High 3.27 (±4.59)
# Gaze: Low 4.83 (±7.00), High 1.73 (±3.67)
# Head: Low 6.57 (±7.82), High 5.10 (±4.96)
# Body: Low 6.93 (±6.80), High 5.77 (±5.14)
# Face: Low 6.10 (±6.98), High 3.93 (±4.09)
...
dat <- data.frame(
  ...
  series   = c("BenchmarkV",
               ...
               "Low","High"),
  mean     = c(bench_mean,
               8.30, 8.63,      # BenchmarkR Low, High
               1.10, 3.27,      # Controller Low, High
               4.83, 1.73,      # Gaze Low, High
               6.57, 5.10,      # Head Low, High
               6.93, 5.77,      # Body Low, High
               6.10, 3.93),     # Face Low, High
  sd       = c(bench_sd,
               6.82, 5.92,      # BenchmarkR Low, High
               4.43, 4.59,      # Controller Low, High
               7.00, 3.67,      # Gaze Low, High
               7.82, 4.96,      # Head Low, High
               6.80, 5.14,      # Body Low, High
               6.98, 4.09),     # Face Low, High
...
ggsave("no_labels/HR_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/HR_with_labels.png", p2, width = 8, height = 3.92, dpi = 300, bg = "white")
