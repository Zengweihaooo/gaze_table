...
# 保存文件
ggsave("no_labels/performance_toc_no_labels.png", p1, width = 8, height = 4.2, dpi = 300, bg = "white")
ggsave("with_labels/performance_toc_with_labels.png", p2, width = 8, height = 4.6, dpi = 300, bg = "white")
