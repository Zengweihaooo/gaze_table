...
# y 轴：0-12，主要刻度间隔为 2
y_top    <- 12
y_breaks <- seq(0, 12, by = 2)  # 0, 2, 4, 6, 8, 10, 12
...
# 保存文件
ggsave("no_labels/performance_toc_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/performance_toc_with_labels.png", p2, width = 8, height = 3.92, dpi = 300, bg = "white")
