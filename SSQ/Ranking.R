...
ggsave("no_labels/Ranking_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/Ranking_with_labels.png", p2, width = 8, height = 3.92, dpi = 300, bg = "white")
