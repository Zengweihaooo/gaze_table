...
# ================= Data =================
# Controller: Low 3.70 (±1.37), High 3.57 (±1.36)
# Gaze: Low 3.73 (±1.20), High 3.90 (±1.18)
# Head: Low 2.00 (±1.31), High 1.90 (±1.24)
# Body: Low 2.73 (±0.98), High 2.37 (±0.93)
# Face: Low 2.83 (±1.46), High 3.27 (±1.34)
...
dat <- data.frame(
  ...
  series   = c("Low","High",
               ...
               "Low","High",
               "Low","High"),
  mean     = c(3.70, 3.57,      # Controller Low, High
               3.73, 3.90,      # Gaze Low, High
               2.00, 1.90,      # Head Low, High
               2.73, 2.37,      # Body Low, High
               2.83, 3.27),     # Face Low, High
  sd       = c(1.37, 1.36,      # Controller Low, High
               1.20, 1.18,      # Gaze Low, High
               1.31, 1.24,      # Head Low, High
               0.98, 0.93,      # Body Low, High
               1.46, 1.34),     # Face Low, High
...
dat$series <- factor(dat$series, levels = c("Low","High"))
...
# y 轴：根据数据范围确定，最大值约 3.90 + 1.18 ≈ 5，设置为 0-5
y_top    <- 5
y_bottom <- 0
...
ggsave("no_labels/Ranking_no_labels.png", p1, width = 8, height = 3.03, dpi = 300, bg = "white")
ggsave("with_labels/Ranking_with_labels.png", p2, width = 8, height = 3.33, dpi = 300, bg = "white")
