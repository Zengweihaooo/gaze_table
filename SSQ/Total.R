...
# ================= Data =================
# BenchmarkV: 13.21 (±27.30)
# BenchmarkR: Low 1.00 (±4.39), High 5.73 (±6.86)
# Controller: Low 3.24 (±10.29), High 2.62 (±5.48)
# Gaze: Low 7.23 (±11.07), High 5.24 (±9.40)
# Head: Low 4.49 (±8.12), High 2.24 (±6.99)
# Body: Low 4.74 (±7.01), High 5.73 (±7.53)
# Face: Low 2.87 (±4.25), High 2.24 (±4.56)
...
dat <- data.frame(
  ...
  series   = c("BenchmarkV",
               ...
               "Low","High"),
  mean     = c(bench_mean,
               1.00, 5.73,       # BenchmarkR Low, High
               3.24, 2.62,       # Controller Low, High
               7.23, 5.24,       # Gaze Low, High
               4.49, 2.24,       # Head Low, High
               4.74, 5.73,       # Body Low, High
               2.87, 2.24),      # Face Low, High
  sd       = c(bench_sd,
               4.39, 6.86,       # BenchmarkR Low, High
               10.29, 5.48,      # Controller Low, High
               11.07, 9.40,      # Gaze Low, High
               8.12, 6.99,       # Head Low, High
               7.01, 7.53,       # Body Low, High
               4.25, 4.56),      # Face Low, High
...
ggsave("no_labels/Total_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/Total_with_labels.png", p2, width = 8, height = 3.91, dpi = 300, bg = "white")
