...
# ================= Data =================
# BenchmarkV: 5.56 (±17.00)
# BenchmarkR: Low 0.25 (±4.21), High 4.80 (±7.31)
# Controller: Low 1.52 (±8.30), High 1.26 (±5.30)
# Gaze: Low 6.82 (±12.00), High 6.57 (±10.48)
# Head: Low 1.52 (±5.42), High 0.76 (±7.00)
# Body: Low 1.52 (±4.18), High 2.78 (±5.80)
# Face: Low 3.28 (±6.51), High 2.27 (±5.32)
...
dat <- data.frame(
  ...
  series   = c("BenchmarkV",
               ...
               "Low","High"),
  mean     = c(bench_mean,
               0.25, 4.80,       # BenchmarkR Low, High
               1.52, 1.26,       # Controller Low, High
               6.82, 6.57,       # Gaze Low, High
               1.52, 0.76,       # Head Low, High
               1.52, 2.78,       # Body Low, High
               3.28, 2.27),      # Face Low, High
  sd       = c(bench_sd,
               4.21, 7.31,       # BenchmarkR Low, High
               8.30, 5.30,       # Controller Low, High
               12.00, 10.48,     # Gaze Low, High
               5.42, 7.00,       # Head Low, High
               4.18, 5.80,       # Body Low, High
               6.51, 5.32),      # Face Low, High
...
ggsave("no_labels/Oculomotor_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/Oculomotor_with_labels.png", p2, width = 8, height = 3.91, dpi = 300, bg = "white")
