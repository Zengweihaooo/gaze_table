...
# ================= Data =================
# BenchmarkV: 6.04 (±19.64)
# BenchmarkR: Low -0.32 (±1.74), High 1.59 (±5.65)
# Controller: Low 1.91 (±8.08), High 0.32 (±3.95)
# Gaze: Low 1.27 (±4.14), High 0.00 (±0.00)
# Head: Low 2.23 (±7.38), High 1.91 (±4.62)
# Body: Low 3.18 (±7.65), High 1.59 (±4.40)
# Face: Low 0.00 (±0.00), High 0.00 (±0.00)
...
dat <- data.frame(
  ...
  series   = c("BenchmarkV",
               ...
               "Low","High"),
  mean     = c(bench_mean,
               -0.32, 1.59,      # BenchmarkR Low, High
               1.91, 0.32,       # Controller Low, High
               1.27, 0.00,       # Gaze Low, High
               2.23, 1.91,       # Head Low, High
               3.18, 1.59,       # Body Low, High
               0.00, 0.00),      # Face Low, High
  sd       = c(bench_sd,
               1.74, 5.65,       # BenchmarkR Low, High
               8.08, 3.95,       # Controller Low, High
               4.14, 0.00,       # Gaze Low, High
               7.38, 4.62,       # Head Low, High
               7.65, 4.40,       # Body Low, High
               0.00, 0.00),      # Face Low, High
...
ggsave("no_labels/Nausea_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/Nausea_with_labels.png", p2, width = 8, height = 3.91, dpi = 300, bg = "white")
