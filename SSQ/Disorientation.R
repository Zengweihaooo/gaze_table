...
# ================= Data =================
# BenchmarkV: 30.16 (±44.33)
# BenchmarkR: Low 3.71 (±9.63), High 10.21 (±15.48)
# Controller: Low 6.50 (±14.50), High 6.96 (±10.18)
# Gaze: Low 12.53 (±19.80), High 7.42 (±17.04)
# Head: Low 10.67 (±16.63), High 4.18 (±12.74)
# Body: Low 10.21 (±13.65), High 13.92 (±20.68)
# Face: Low 4.64 (±8.44), High 4.18 (±12.21)
...
dat <- data.frame(
  ...
  series   = c("BenchmarkV",
               ...
               "Low","High"),
  mean     = c(bench_mean,
               3.71, 10.21,      # BenchmarkR Low, High
               6.50, 6.96,      # Controller Low, High
               12.53, 7.42,     # Gaze Low, High
               10.67, 4.18,     # Head Low, High
               10.21, 13.92,    # Body Low, High
               4.64, 4.18),      # Face Low, High
  sd       = c(bench_sd,
               9.63, 15.48,      # BenchmarkR Low, High
               14.50, 10.18,     # Controller Low, High
               19.80, 17.04,     # Gaze Low, High
               16.63, 12.74,     # Head Low, High
               13.65, 20.68,     # Body Low, High
               8.44, 12.21),     # Face Low, High
...
ggsave("no_labels/Disorientation_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/Disorientation_with_labels.png", p2, width = 8, height = 3.91, dpi = 300, bg = "white")
