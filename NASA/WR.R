...
# ================= Data =================
# BenchmarkV: 31.76 (±14.71)
# BenchmarkR: Low 27.59 (±13.92), High 37.41 (±15.38)
# Controller: Low 51.76 (±15.17), High 57.96 (±15.35)
# Gaze: Low 46.39 (±16.35), High 60.19 (±16.50)
# Head: Low 36.11 (±12.36), High 50.28 (±16.35)
# Body: Low 39.63 (±14.26), High 56.11 (±17.56)
# Face: Low 38.52 (±15.78), High 53.24 (±15.98)
...
dat <- data.frame(
  ...
  series   = c("BenchmarkV",
               ...
               "Low","High"),
  mean     = c(bench_mean,
               27.59, 37.41,      # BenchmarkR Low, High
               51.76, 57.96,      # Controller Low, High
               46.39, 60.19,      # Gaze Low, High
               36.11, 50.28,      # Head Low, High
               39.63, 56.11,      # Body Low, High
               38.52, 53.24),     # Face Low, High
  sd       = c(bench_sd,
               13.92, 15.38,      # BenchmarkR Low, High
               15.17, 15.35,      # Controller Low, High
               16.35, 16.50,      # Gaze Low, High
               12.36, 16.35,      # Head Low, High
               14.26, 17.56,      # Body Low, High
               15.78, 15.98),     # Face Low, High
...
ggsave("no_labels/WR_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/WR_with_labels.png", p2, width = 8, height = 3.91, dpi = 300, bg = "white")
