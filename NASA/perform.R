...
# ================= Data =================
# BenchmarkV: 32.78 (±24.56)
# BenchmarkR: Low 24.44 (±14.34), High 42.22 (±21.77)
# Controller: Low 52.78 (±19.12), High 58.89 (±18.43)
# Gaze: Low 45.56 (±17.47), High 65.56 (±23.54)
# Head: Low 31.11 (±18.94), High 52.78 (±20.57)
# Body: Low 32.78 (±18.30), High 53.89 (±17.33)
# Face: Low 39.44 (±20.29), High 56.11 (±18.82)
...
dat <- data.frame(
  ...
  series   = c("BenchmarkV",
               ...
               "Low","High"),
  mean     = c(bench_mean,
               24.44, 42.22,      # BenchmarkR Low, High
               52.78, 58.89,      # Controller Low, High
               45.56, 65.56,      # Gaze Low, High
               31.11, 52.78,      # Head Low, High
               32.78, 53.89,      # Body Low, High
               39.44, 56.11),     # Face Low, High
  sd       = c(bench_sd,
               14.34, 21.77,      # BenchmarkR Low, High
               19.12, 18.43,      # Controller Low, High
               17.47, 23.54,      # Gaze Low, High
               18.94, 20.57,      # Head Low, High
               18.30, 17.33,      # Body Low, High
               20.29, 18.82),     # Face Low, High
...
ggsave("no_labels/perform_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/perform_with_labels.png", p2, width = 8, height = 3.91, dpi = 300, bg = "white")
