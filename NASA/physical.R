...
# ================= Data =================
# BenchmarkV: 26.67 (±24.60)
# BenchmarkR: Low 31.11 (±25.42), High 29.44 (±22.18)
# Controller: Low 41.11 (±23.46), High 45.00 (±24.43)
# Gaze: Low 38.89 (±27.80), High 45.56 (±25.50)
# Head: Low 47.78 (±26.16), High 51.11 (±28.68)
# Body: Low 52.78 (±23.19), High 59.44 (±26.51)
# Face: Low 36.67 (±26.77), High 44.44 (±27.45)
...
dat <- data.frame(
  ...
  series   = c("BenchmarkV",
               ...
               "Low","High"),
  mean     = c(bench_mean,
               31.11, 29.44,      # BenchmarkR Low, High
               41.11, 45.00,      # Controller Low, High
               38.89, 45.56,      # Gaze Low, High
               47.78, 51.11,      # Head Low, High
               52.78, 59.44,      # Body Low, High
               36.67, 44.44),     # Face Low, High
  sd       = c(bench_sd,
               25.42, 22.18,      # BenchmarkR Low, High
               23.46, 24.43,      # Controller Low, High
               27.80, 25.50,      # Gaze Low, High
               26.16, 28.68,      # Head Low, High
               23.19, 26.51,      # Body Low, High
               26.77, 27.45),     # Face Low, High
...
ggsave("no_labels/physical_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/physical_with_labels.png", p2, width = 8, height = 3.91, dpi = 300, bg = "white")
