...
# ================= Data =================
# BenchmarkV: 51.11 (±23.54)
# BenchmarkR: Low 53.89 (±28.93), High 59.44 (±23.03)
# Controller: Low 69.44 (±21.03), High 72.22 (±20.68)
# Gaze: Low 66.67 (±21.44), High 73.33 (±21.71)
# Head: Low 58.89 (±25.04), High 66.67 (±23.16)
# Body: Low 59.44 (±23.44), High 70.00 (±23.33)
# Face: Low 60.00 (±26.48), High 70.00 (±21.62)
...
dat <- data.frame(
  ...
  series   = c("BenchmarkV",
               ...
               "Low","High"),
  mean     = c(bench_mean,
               53.89, 59.44,      # BenchmarkR Low, High
               69.44, 72.22,      # Controller Low, High
               66.67, 73.33,      # Gaze Low, High
               58.89, 66.67,      # Head Low, High
               59.44, 70.00,      # Body Low, High
               60.00, 70.00),     # Face Low, High
  sd       = c(bench_sd,
               28.93, 23.03,      # BenchmarkR Low, High
               21.03, 20.68,      # Controller Low, High
               21.44, 21.71,      # Gaze Low, High
               25.04, 23.16,      # Head Low, High
               23.44, 23.33,      # Body Low, High
               26.48, 21.62),     # Face Low, High
...
ggsave("no_labels/effort_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/effort_with_labels.png", p2, width = 8, height = 3.91, dpi = 300, bg = "white")
