...
# ================= Data =================
# BenchmarkV: 24.44 (±24.66)
# BenchmarkR: Low 42.22 (±29.27), High 44.44 (±29.47)
# Controller: Low 65.56 (±20.50), High 67.78 (±23.13)
# Gaze: Low 48.33 (±24.51), High 65.00 (±26.02)
# Head: Low 34.44 (±25.50), High 51.67 (±26.75)
# Body: Low 41.67 (±28.28), High 60.00 (±28.57)
# Face: Low 36.67 (±23.33), High 53.33 (±24.53)
...
dat <- data.frame(
  ...
  series   = c("BenchmarkV",
               ...
               "Low","High"),
  mean     = c(bench_mean,
               42.22, 44.44,      # BenchmarkR Low, High
               65.56, 67.78,      # Controller Low, High
               48.33, 65.00,      # Gaze Low, High
               34.44, 51.67,      # Head Low, High
               41.67, 60.00,      # Body Low, High
               36.67, 53.33),     # Face Low, High
  sd       = c(bench_sd,
               29.27, 29.47,      # BenchmarkR Low, High
               20.50, 23.13,      # Controller Low, High
               24.51, 26.02,      # Gaze Low, High
               25.50, 26.75,      # Head Low, High
               28.28, 28.57,      # Body Low, High
               23.33, 24.53),     # Face Low, High
...
ggsave("no_labels/time_no_labels.png", p1, width = 8, height = 3.57, dpi = 300, bg = "white")
ggsave("with_labels/time_with_labels.png", p2, width = 8, height = 3.91, dpi = 300, bg = "white")
